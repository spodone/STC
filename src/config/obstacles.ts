...
export const OBSTACLE_DEFINITIONS: readonly ObstacleDefinition[] = [
  ...
  { kind: "selfieGuy", motion: "swooping", textureKey: "selfieGuy", hitboxScale: 0.85, weight: 8, unlockAtSeconds: 6, jumpable: false, artPath: "art/obstacles/selfie.png", displayWidth: 120, spriteOriginY: 0.95 },
  ...
  { kind: "protester", motion: "swooping", textureKey: "protester", hitboxScale: 0.9, weight: 5, unlockAtSeconds: 20, jumpable: false, artPath: "art/obstacles/protester.png", displayWidth: 128, spriteOriginY: 0.951 },
